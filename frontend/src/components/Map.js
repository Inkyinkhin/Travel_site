...
const statesAndCities = {
  ...
  Magway: {
    Magway: [20.15, 94.9333],
    Pakokku: [21.3833, 95.0667],
    Sidoktaya: [20.7047, 94.881],
    Chauk: [20.7464, 94.956],
  ...
  Tanintharyi: {
    ...
    Tanintharyi: [14.55, 98.1667],
    Bagan: [12.4733, 98.3167],
    Palaw: [14.0739, 98.2058],
    Kyeikphyu: [14.46, 98.0694],
  },
};
                  ...
                  >
                    <ListItemText
                      ...
                      primaryTypographyProps={{
                        style: { fontWeight: "500", height: "8px" },
                      }}
                    />
                    <Divider />
                  </ListItem>
